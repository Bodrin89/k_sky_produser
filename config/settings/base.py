...
SPECTACULAR_SETTINGS = {'TITLE': 'Web', 'DESCRIPTION': 'Web service'}
...
URL_GET_COLOR_NAME = 'https://www.thecolorapi.com/id'
...
LOGGING = {
    ...
    'handlers': {
        'console': {'class': 'logging.StreamHandler', 'formatter': 'main_format', 'level': 'WARNING'},
        'file': {
